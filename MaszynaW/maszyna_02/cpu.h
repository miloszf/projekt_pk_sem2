...
/** Funkcja inicjalizuj¹ca obiekt struktury CPU.
...
/** Funkcja zwracaj¹ca flagi gotowoœci do zapisania/odczytania znaku przez maszynê.
@param cpu jednostka centralna
