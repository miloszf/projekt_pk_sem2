...
/** Funkcja inicjalizuj¹ca rejstry obs³uguj¹ce we/wy.
@param cpu jednostka centralna
@param offset pozycja wzglêdem lewego górnego rogu sceny
@param canvas scena */
...
/** Funkcja inicjalizuj¹ca rejstry obs³uguj¹ce przerwania.
@param cpu jednostka centralna
@param offset pozycja wzglêdem lewego górnego rogu sceny
@param canvas scena */
void cpu_init_intr_units(struct CPU* cpu, const Point offset, struct Canvas* canvas);
/** Funkcja inicjalizuj¹ca sygna³y obs³uguj¹ce przerwania.
@param cpu jednostka centralna
@param offset pozycja wzglêdem lewego górnego rogu sceny
@param canvas scena */
