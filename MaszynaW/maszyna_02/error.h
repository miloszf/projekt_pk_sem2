...
/** Makro s³u¿¹ce do do sprawdzania czy podany wskaŸnik ma wartoœæ '0'. Jeœli tak, aplikacja koñczy dzia³anie.  */
...
#define LOST_TICK			0x0040	///< takt instrukcji nigy nie zostanie wykonany
#define FULL_MEMORY			0x0080	///< pe³na pamiêæ programu

/** B³êdy wykonywania programu. */
typedef Error RuntimeError;
#define CPU_STOPPED			0x0001	///< sygna³ 'stp' zosta³ ustawiony
...
@param typ b³êdu kompilacji
@param dodatkowa informacja tekstowa (opcjonalne) */
